(function () {
    ...
    module.exports = function(app) {
        ...
        describe('API Hits', function() {
            ...
            it('GET /api/servers/:id/hits/grouped should contain 2 hits', function (done) {
                request(app)
                    .post('/api/hits')
                    .send([
                    exampleHit(),
                    ...
                    .end(function(err, res) {
                        ...
                        request(app)
                            .get('/api/servers/' + res.body[0].server + '/hits/grouped')
                            .expect(200)
                            .end(function(err, res){
                                if (err) {
                                    return done(err);
            ...
            it('GET /api/users/:id/hits/grouped should contain 2 hits', function (done) {
                request(app)
                    .post('/api/hits')
                    .send([
                    exampleHit(),
                    ...
                    .end(function(err, res) {
                        ...
                        request(app)
                            .get('/api/users/' + res.body[0].user + '/hits/grouped')
                            .expect(200)
                            .end(function(err, res){
                                if (err) {
                                    return done(err);
